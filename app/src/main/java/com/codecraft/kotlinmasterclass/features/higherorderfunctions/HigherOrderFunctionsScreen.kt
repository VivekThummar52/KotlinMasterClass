package com.codecraft.kotlinmasterclass.features.higherorderfunctions
...
fun HigherOrderFunctionsScreen(
    viewModel: HigherOrderFunctionsViewModel = hiltViewModel(),
    onBackClick: () -> Unit,
...
@Composable
fun HigherOrderFunctionsScreenPreview() {
